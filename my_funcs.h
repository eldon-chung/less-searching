...
public void dump_screen LESSPARAMS ((VOID_PARAM));
...
public int compile_pattern LESSPARAMS ((char *pattern, int search_type, int show_error, union compiled_pattern *comp_pattern));
public void uncompile_pattern LESSPARAMS ((PATTERN_TYPE *pattern));
public void uncompile_no_regex_pattern (NO_REGEX_PATTERN_TYPE *pattern);
public int valid_pattern LESSPARAMS ((char *pattern));
public int is_null_pattern LESSPARAMS ((PATTERN_TYPE pattern));
public int match_pattern LESSPARAMS ((union compiled_pattern pattern, char *tpattern, char *line, int line_len, char **sp, char **ep, int notbol, int search_type));
...
public void xbuf_add_byte LESSPARAMS ((struct xbuffer *xbuf, unsigned char b));
public void  xbuf_add_data LESSPARAMS ((struct xbuffer *xbuf, unsigned char *data, int len));
public int xbuf_pop LESSPARAMS ((struct xbuffer *buf));
public void xbuf_set LESSPARAMS ((struct xbuffer *dst, struct xbuffer *src));
public char * xbuf_char_data LESSPARAMS ((struct xbuffer *xbuf));
